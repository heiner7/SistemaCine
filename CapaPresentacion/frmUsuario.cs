    ...
    public partial class frmUsuario : Form
    {
        ...
        private void btnInsertarUsuario_Click(object sender, EventArgs e)
        {
            if (Validar() == 0)
            {
                ...
                {
                    elUsuario.InsertarUsuario(int.Parse(cbxTipo.SelectedIndex.ToString()), txtUsuario_nombre.Text, cbxTipo.SelectedItem.ToString(),  txtUsuario_contrasenna.Text, "A");
                }
                CargarGridUsuario();
        ...
        private void btnModificarUsuario_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (GestorUsuario elUsuario = new GestorUsuario())
                {
                    elUsuario.ModificarUsuario(int.Parse(this.dtUsuario.Rows[0]["Usuario_id"].ToString()), txtUsuario_nombre.Text, cbxTipo.SelectedItem.ToString(), txtUsuario_contrasenna.Text,"A");
                }
                CargarGridUsuario();
                dsUsuario = null;
                dtUsuario = null;
        ...
        private int Validar()
        {
            ...
            {
                epError.SetError(cbxTipo, "Seleccionar...");
                cbxTipo.Focus();
                return 1;
            }
            else
