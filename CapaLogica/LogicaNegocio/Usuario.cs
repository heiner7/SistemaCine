...
namespace SistemaMatricula.CapaLogica.LogicaNegocio
{
    public class Usuario
    {
        ...
        public Usuario(string Pusuario_nombre, string Pusuario_tipo, string Pusuario_contrasenna, string Pusuario_estado)
        {
            Usuario_id = 0;
        ...
        public Usuario(int Pusuario_id, string Pusuario_nombre, string Pusuario_tipo, string Pusuario_contrasenna, string Pusuario_estado)
        {
